...
| Report archivers | `plugins/*/Archiver.php` | 19 archivers | Archive storage, day and parent core metrics, cache reuse, failure markers, extension events, all bundled segment families, active site-configured custom dimensions, and 23 visit-derived report records ported, including goal and ecommerce enrichment for time, device, and location reports; specialized action, conversion, event, goal, and plugin records remain |
