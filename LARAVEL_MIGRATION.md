...
| Report archivers | `plugins/*/Archiver.php` | 19 archivers | Archive storage, day and parent core metrics, cache reuse, failure markers, extension events, all bundled segment families, active site-configured custom dimensions, and 14 visit-dimension report records ported; specialized action, conversion, engagement, device-plugin, location, and plugin records remain |
