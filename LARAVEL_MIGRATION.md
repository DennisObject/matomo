...
| Report archivers | `plugins/*/Archiver.php` | 18 archivers | Archive storage, day and parent core metrics, cache reuse, failure markers, and extension events ported; built-in reports and segment translation remain |
