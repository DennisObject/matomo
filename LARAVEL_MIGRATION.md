...
| --- | --- | ---: | --- |
| Reporting API methods | `plugins/*/API.php` | 389 methods | 151 method names handled |
...
- `Transitions`: `getTranslations`, including the complete localized metric and client key contract.
