...
| Report archivers | `plugins/*/Archiver.php` | 18 archivers | Archive storage, day and parent core metrics, cache reuse, failure markers, extension events, and built-in visit segment translation ported; built-in reports plus action, conversion, and dynamic segments remain |
