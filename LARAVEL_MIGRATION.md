...
| Report archivers | `plugins/*/Archiver.php` | 18 archivers | Archive storage, day and parent core metrics, cache reuse, failure markers, extension events, and built-in visit and action segment translation ported; built-in reports plus conversion and dynamic segments remain |
