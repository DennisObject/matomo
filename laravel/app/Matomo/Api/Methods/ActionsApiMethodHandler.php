...
final readonly class ActionsApiMethodHandler implements ApiMethodHandler
{
    public function __construct(
        ...
        private ActionsReportBuilder $reports,
        private RssReportRenderer $rss,
    ) {}

    public function supports(ApiRequest $request): bool
    {
        return $request->isActionsRequest();
    }

    public function handle(ApiRequest $request, Request $httpRequest): Response
    {
        if (! $this->supports($request)) {
            throw new LogicException('The Actions API handler does not support this request.');
        }

        $query = $request->visitsSummary ?? throw new LogicException('The Actions report request was not parsed.');
        $actions = $request->actions ?? throw new LogicException('The Actions request was not parsed.');
        ...
        $report = $this->reports->table(
            ...
            flat: $query->flat,
            showDimensions: $query->showDimensions,
