...
use App\Matomo\Reporting\ReferrersSocialReportBuilder;
...
final readonly class ReferrersSocialApiMethodHandler implements ApiMethodHandler
{
    public function __construct(
        ...
        private ReferrersSocialReportBuilder $reports,
        private RssReportRenderer $rss,
    ) {}

    public function supports(ApiRequest $request): bool
    {
        return $request->isReferrersSocialRequest();
    }

    public function handle(ApiRequest $request, Request $httpRequest): Response
    {
        if (! $this->supports($request)) {
            throw new LogicException('The Referrers social API handler does not support this request.');
        }

        $query = $request->visitsSummary
            ?? throw new LogicException('The Referrers social request was not parsed.');
