...
final readonly class ApiRequest
{
    ...
    public function isReferrersWebsiteRequest(): bool
    {
        return $this->module === 'API'
    ...
    private static function privacyComplianceRead(
        Request $request,
        string $module,
        string $method,
    ): ?PrivacyComplianceReadRequest {
        if ($module !== 'API' || $method !== 'PrivacyManager.getComplianceStatus') {
            return null;
        }
